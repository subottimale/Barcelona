...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	CTL_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT,           
		    ALT_ENT, KC_ENT, KC_NO, KC_NO, KC_SPC, ALT_TAB                                            
	),
...
KC_LALT, UNDO, KC_LSFT, KC_NO, KC_NO, KC_NO, QK_LEAD, KC_NO, QK_BOOT,          
		    KC_NO, KC_SCROLL_LOCK, KC_NO, KC_NO, KC_NO, KC_NO                                            
	),
	...
	KC_LCTL, KC_NO, KC_NO, KC_BTN2, KC_NO, RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD,          
		    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO                                            
	)
